...
class Settings:
    ...
    agentspan_model: str = "anthropic/claude-sonnet-4-6"
    agentspan_server_url: str = "http://localhost:6767/api"
    agentspan_max_results: int = 6
...
def load_settings() -> Settings:
    return Settings(
        ...
        agentspan_model=os.getenv("AGENTSPAN_LLM_MODEL", "anthropic/claude-sonnet-4-6"),
        agentspan_server_url=os.getenv("AGENTSPAN_SERVER_URL", "http://localhost:6767/api"),
        agentspan_max_results=_env_int("AGENTSPAN_MAX_RESULTS", 6),
